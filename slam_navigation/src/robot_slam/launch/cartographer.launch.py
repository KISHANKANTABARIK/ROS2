...
def generate_launch_description():
    prefix_address = get_package_share_directory('robot_slam') 
    ...
    return LaunchDescription([
        ...
        # Configuration directories for Cartographer
        DeclareLaunchArgument(
        ...
        Node(
            ...
            # remappings=[
            #     ('/scan', '/bumpy1/scan'),
            #     # Add other remappings if needed
            # ],
            output='screen'
        ),

        # Occupancy Grid Node - Always start this for visualization
        Node(
            package='cartographer_ros',
